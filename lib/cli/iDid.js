...
function iDid(ididOptions) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ididOptions.start = luxon_1.DateTime.fromJSDate(ididOptions.start).toString();
            ididOptions.tz = luxon_1.DateTime.local().zoneName;
            console.log(ididOptions);
            return [2 /*return*/];
        });
    });
}
